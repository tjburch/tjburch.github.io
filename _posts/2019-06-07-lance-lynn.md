...
Already this plot is a bit surprising, the expectation for such a distribution would be to follow a typical aging curve, but, excluding the outlier, Lynn seems to be continuing to improve. If you do drop off the outlier, remove his missed year for Tommy John surgery, a linear regression does quite well in describing his improvement year-to-year:
